...
resource "oci_identity_policy" "rallly_policy" {
  ...
  statements = [
    ...
    "Allow dynamic-group id ${oci_identity_domains_dynamic_resource_group.rallly_dynamic_group.ocid} to use log-content in compartment id ${var.compartment_ocid}"
  ]
}
